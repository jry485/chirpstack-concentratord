...
pub fn get(filenames: Vec<String>) -> Configuration {
    ...
    config.gateway.model_config = match config.gateway.model.as_ref() {
        ...
        "waveshare_sx1302_lorawan_gateway_hat_eu868" => vendor::waveshare::sx1302_lorawan_gateway_hat_eu868::new(&config),
        "waveshare_sx1302_lorawan_gateway_hat_cn470" => vendor::waveshare::sx1302_lorawan_gateway_hat_cn470::new(&config),
